...
# git clone -b 18.06  https://github.com/cocokfeng/luci-theme-argon.git package/lean/luci-theme-argon
# svn co https://github.com/cocokfeng/luci-app-argon-config/trunk package/luci-app-argon-config
# git clone -b 18.06  https://github.com/cocokfeng/luci-theme-argon.git package/lean/luci-argon
...
cp -f package/lean/luci-argon/htdocs/luci-static/argon/img/bg1.jpg package/lean/luci-theme-argon/htdocs/luci-static/argon/img/bg1.jpg
